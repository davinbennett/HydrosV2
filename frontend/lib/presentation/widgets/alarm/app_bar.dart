...
enum AppBarAlarmType { main, back, withoutNotif }

class AppBarAlarmWidget extends ConsumerWidget {
  final AppBarAlarmType type;
  final String title;
  final VoidCallback? onBack;
  final VoidCallback? onNotificationTap;

  const AppBarAlarmWidget({
    super.key,
    required this.type,
    required this.title,
    this.onBack,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    switch (type) {
      ...
      case AppBarAlarmType.withoutNotif:
        return Padding(
          padding: EdgeInsets.only(bottom: AppSpacingSize.l),
          child: Stack(
            alignment: Alignment.center,
